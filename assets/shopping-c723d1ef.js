import{B as m,l as d}from"./modal-authorization-30e616a6.js";const a=document.querySelector(".book-list"),g=new m;function u(t){const s=t.closest(".book-item"),o=Array.from(s.parentNode.children),c=o.indexOf(s);if(s.remove(),o.forEach((l,n)=>{n>=c&&(l.style.transform=`translateY(-${s.offsetHeight}px)`)}),Array.from(document.querySelectorAll(".book-item")).length===0){const l=document.createElement("img");l.src="../img/blocks.png",l.alt="Зображення порожнього списку покупок",a.appendChild(l)}}g.fetchBooksByCategory("Young Adult Paperback Monthly").then(t=>{const s=t;if(console.log(t),s.length>0)s.forEach(o=>{const c=document.createElement("li");c.classList.add("book-item"),c.innerHTML=`
          <div class="book-card">
            <div>
