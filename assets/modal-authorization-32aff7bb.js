 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rh(t){vt(new Ye("platform-logger",e=>new qu(e),"PRIVATE")),vt(new Ye("heartbeat",e=>new Ch(e),"PRIVATE")),Ue(_r,Ys,t),Ue(_r,Ys,"esm2017"),Ue("fire-js","")}Rh("");var Dh="firebase",Nh="9.23.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ca{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}Ca.type="NONE";const ro=Ca;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function so(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Ra(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(ka(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Na(e))return"Blackberry";if(Oa(e))return"Webos";if(is(e))return"Safari";if((e.includes("chrome/")||ba(e))&&!e.includes("edge/"))return"Chrome";if(Da(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function ka(t=Y()){return/firefox\//i.test(t)}function is(t=Y()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function ba(t=Y()){return/crios\//i.test(t)}function Ra(t=Y()){return/iemobile/i.test(t)}function Da(t=Y()){return/android/i.test(t)}function Na(t=Y()){return/blackberry/i.test(t)}function Oa(t=Y()){return/webos/i.test(t)}function Si(t=Y()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function Jh(t=Y()){var e;return Si(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Yh(){return gu()&&document.documentMode===10}function Pa(t=Y()){return Si(t)||Da(t)||Oa(t)||Na(t)||/windows phone/i.test(t)||Ra(t)}function Zh(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const If={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},_f=500,Tf=600,Sf="_blank",Af="http://localhost";class go{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Cf(t,e,n,i=_f,r=Tf){const s=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const c=Object.assign(Object.assign({},If),{width:i.toString(),height:r.toString(),top:s,left:o}),l=Y().toLowerCase();n&&(a=ba(l)?Sf:n),ka(l)&&(e=e||Af,c.scrollbars="yes");const u=Object.entries(c).reduce((p,[y,_])=>`${p}${y}=${_},`,"");if(Jh(l)&&a!=="_self")return kf(e||"",a),new go(null);const h=window.open(e||"",a,u);v(h,t,"popup-blocked");try{h.focus()}catch{}return new go(h)}function kf(t,e){const n=document.createElement("a");n.href=t,n.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(i){try{return atob(i)}catch(r){throw typeof DOMException<"u"&&r instanceof DOMException?new lg("Invalid base64 string: "+r):r}}(e);return new ke(n)}static fromUint8Array(e){const n=function(i){let r="";for(let s=0;s<i.length;++s)r+=String.fromCharCode(i[s]);return r}(e);return new ke(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return e=this.binaryString,btoa(e);var e}toUint8Array(){return function(e){const n=new Uint8Array(e.length);for(let i=0;i<e.length;i++)n[i]=e.charCodeAt(i);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return R(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}ke.EMPTY_BYTE_STRING=new ke("");const ug=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function rt(t){if(B(!!t),typeof t=="string"){let e=0;const n=ug.exec(t);if(B(!!n),n[1]){let r=n[1];r=(r+"000000000").substr(0,9),e=Number(r)}const i=new Date(t);return{seconds:Math.floor(i.getTime()/1e3),nanos:e}}return{seconds:H(t.seconds),nanos:H(t.nanos)}}function H(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function dn(t){return typeof t=="string"?ke.fromBase64String(t):ke.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qi{constructor(){this._=void 0}}function xg(t,e,n){return t instanceof Ii?function(i,r){const s={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:i.seconds,nanos:i.nanoseconds}}}};return r&&Os(r)&&(r=ol(r)),r&&(s.fields.__previous_value__=r),{mapValue:s}}(n,e):t instanceof Ct?_l(t,e):t instanceof kt?Tl(t,e):function(i,r){const s=Il(i,r),o=qo(s)+qo(i.gt);return Br(s)&&Br(i.gt)?El(o):wl(i.serializer,o)}(t,e)}function Ug(t,e,n){return t instanceof Ct?_l(t,e):t instanceof kt?Tl(t,e):n}function Il(t,e){return t instanceof _i?Br(n=e)||function(i){return!!i&&"doubleValue"in i}(n)?e:{integerValue:0}:null;var n}class Ii extends qi{}class Ct extends qi{constructor(e){super(),this.elements=e}}function _l(t,e){const n=Sl(e);for(const i of t.elements)n.some(r=>Ie(r,i))||n.push(i);return{arrayValue:{values:n}}}class kt extends qi{constructor(e){super(),this.elements=e}}function Tl(t,e){let n=Sl(e);for(const i of t.elements)n=n.filter(r=>!Ie(r,i));return{arrayValue:{values:n}}}class _i extends qi{constructor(e,n){super(),this.serializer=e,this.gt=n}}function qo(t){return H(t.integerValue||t.doubleValue)}function Sl(t){return Ps(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new mn(ke.fromBase64String(e))}catch(n){throw new w(d.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new mn(ke.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vy(t,e,n){let i;return i=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,i}function wy(t,e,n){t=pn(t,we);const i=pn(t.firestore,zs),r=vy(t.converter,e,n);return Jl(i,[dy(zl(i),"setDoc",t._key,r,t.converter!==null,n).toMutation(t._key,ve.none())])}function ra(t,e,n,...i){t=pn(t,we);const r=pn(t.firestore,zs),s=zl(r);let o;return o=typeof(e=Z(e))=="string"||e instanceof Ks?my(s,"updateDoc",t._key,e,n,i):gy(s,"updateDoc",t._key,e),Jl(r,[o.toMutation(t._key,ve.exists(!0))])}function Jl(t,e){return function(n,i){const r=new Je;return n.asyncQueue.enqueueAndForget(async()=>Km(await ny(n),i,r)),r.promise}(cy(t),e)}function Ey(...t){return new fy("arrayUnion",t)}function Iy(...t){return new py("arrayRemove",t)}(function(t,e=!0){(function(n){Mt=n})(Rt),vt(new Ye("firestore",(n,{instanceIdentifier:i,options:r})=>{const s=n.getProvider("app").getImmediate(),o=new zs(new Xp(n.getProvider("auth-internal")),new eg(n.getProvider("app-check-internal")),function(a,c){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new w(d.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new vi(a.options.projectId,c)}(s,i),s);return r=Object.assign({useFetchStreams:e},r),o._setSettings(r),o},"PUBLIC").setMultipleInstances(!0)),Ue(Lo,"3.13.0",t),Ue(Lo,"3.13.0","esm2017")})();const _y=document.querySelector("#authorization"),Yl=ma(tu);function Ty(){const t=document.querySelector(".user-name"),e=document.querySelector("#userPhoto"),n=document.querySelector("#arrow"),i=localStorage.getItem("name");t.textContent=`${i}`,e.classList.remove("inactive"),n.style.fill="#ffffff",n.style.stroke="#ffffff"}const sa={auth:Bf(Yl),async signUp(t,e,n){if(typeof t!="string"||t.trim()===""||typeof e!="string"||e.trim()===""||typeof n!="string"||n.trim()==="")throw new Error("Невірний тип даних вхідних параметрів.");try{const i=await Id(this.auth,e,n);return await this.updateUserName(i.user,t),console.log(i.user),await this.signIn(e,n),await this.checkAuth(),i}catch(i){throw console.error("Помилка при реєстрації користувача:",i,i.code),new Error("Не вдалося зареєструвати користувача.")}},signIn(t,e){if(typeof t!="string"||t.trim()===""||typeof e!="string"||e.trim()==="")throw new Error("Невірний тип даних вхідних параметрів.");try{return _d(this.auth,t,e),this.checkAuth()}catch{throw new Error("Не вдалося авторизувати користувача.")}},async updateUserName(t,e){try{await Sd(t,{displayName:e}),console.log("User name updated successfully")}catch(n){console.log("Error updating user name:",n)}},checkAuth(t){return kd(this.auth,e=>{e&&(localStorage.clear(),console.dir(e),_y.classList.add("visually-hidden"),localStorage.setItem("uid",e.uid),localStorage.setItem("exist",!0),localStorage.setItem("name",e.displayName),Ty())})}};ay(Yl);const Kr=document.getElementById("logout-button"),Sy=document.querySelector("#authorization"),Ay=document.querySelector("#mobile-menu"),Cy=document.querySelector(".header-container"),ky=document.querySelector("#mob-menu-open"),by=document.querySelector("#m-close"),Wr=document.querySelector("#btn-signup"),oa=document.querySelector("#avatar"),aa=document.querySelector("#blokLinkMb"),Ry=document.querySelector("#mobileUN");function xy(){localStorage.getItem("exist")?(Wr.style.display="none",oa.style.display="flex",aa.style.display="flex",Kr.style.display="flex",Ry.textContent=`${localStorage.getItem("name")}`):(Wr.style.display="block",oa.style.display="none",aa.style.display="none",Kr.style.display="none")}function Dy(t){t.preventDefault(),localStorage.clear(),location.reload()}function Ny(){Sy.classList.remove("visually-hidden"),Ay.classList.add("hidden"),Cy.classList.remove("fixed"),ky.classList.remove("inactive"),by.classList.remove("active"),console.log("2")}Wr.addEventListener("click",Ny);Kr.addEventListener("click",Dy);const Uy="shoping-list";const yt=document.querySelector(".sign-form"),Oy=document.querySelectorAll('input[type="radio"]'),le={backdrop:document.querySelector("#authorization"),open:document.querySelector(".heder-modal-login"),close:document.querySelector(".modal-authorization-close"),logoutBtn:document.querySelector("#logOut"),modWindow:document.querySelector(".modal-authorization")};le.open.addEventListener("click",yn);le.close.addEventListener("click",yn);localStorage.getItem("exist")?(le.open.removeEventListener("click",yn),le.open.addEventListener("click",Gr),le.logoutBtn.addEventListener("click",Zl)):(le.open.addEventListener("click",yn),le.open.removeEventListener("click",Gr));function yn(){le.backdrop.classList.toggle("visually-hidden")}function Gr(){le.logoutBtn.classList.toggle("active")}function Zl(t){t.preventDefault(),localStorage.clear(),location.reload()}Oy.forEach(t=>{t.addEventListener("change",()=>{t.value==="sign-in"?My():Ly()})});yt.addEventListener("submit",Py);function Py(t){t.preventDefault();const{name:e=null,email:n,password:i}=yt;e?(sa.signUp(e.value,n.value,i.value).then(r=>{}),yt.reset()):(sa.signIn(n.value,i.value),yt.reset()),le.open.removeEventListener("click",yn),le.open.addEventListener("click",Gr),le.logoutBtn.addEventListener("click",Zl)}function Ly(){yt.innerHTML=`<label for="name" class="visually-hidden">name</label>
      <input
        type="text"
        id="name"
        name="name"
  ...
  <button type="submit" class="submit-btn" id="submit">Sign in</button>`}export{Uy as a,Ty as l,xy as m};
